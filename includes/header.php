...
<head>
    ...
    <title>Leeds International</title>
...
<body>
    <header>
        ...
        <nav>
            <?php if (isLoggedIn()): ?>
                <?php if (isAdmin()): ?>
                    <a href="/project/admin/index.php">Dashboard</a>
                    <a href="/project/admin/manage_users.php">Manage Users</a>
                    <a href="/project/admin/manage_teachers.php">Manage Teachers</a>
                    <a href="/project/admin/manage_staff.php">Manage Staff</a>
                    <a href="/project/admin/manage_timetables.php">Timetables</a>
                    <a href="/project/admin/view_feedback.php">Feedback</a>
