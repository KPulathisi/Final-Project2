...
<div class="hero-section">
    <div class="hero-content">
        <h2>Welcome to Leeds High School</h2>
...
<div class="home-sections">
    ...
    <div class="home-section">
        ...
        <ul>
            ...
            <li>
                ...
                <p>Leeds High School athletics team secured the regional championship</p>
            </li>
            <li>
    ...
    <div class="home-section">
        ...
        <p>Founded in 1980, Leeds High School has been a pillar of quality education for over four decades.</p>
        <ul>
...
<div class="contact-feedback">
    ...
    <div class="card">
        ...
        <p><strong>Address:</strong> No.43/A,Walasmulla Road,Beliatta.</p>
        <p><strong>Phone:</strong> 047-1234567</p>
        <p><strong>Email:</strong> info@leedsinternational.com</p>
        <p><strong>Office Hours:</strong> Monday to Friday, 8:00 AM to 2:00 PM</p>
    </div>
